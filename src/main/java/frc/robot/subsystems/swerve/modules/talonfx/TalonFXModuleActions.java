...
//    private final TorqueCurrentFOC driveTorqueRequest;
    private final TorqueCurrentFOC driveVoltageRequest;
...
//        this.driveVoltageRequest = new VoltageOut(0).withEnableFOC(constants.getEnableFOCDrive());
        this.driveVoltageRequest = new TorqueCurrentFOC(0);
        this.driveVelocityRequest = new VelocityTorqueCurrentFOC(0).withSlot(1);
    }
