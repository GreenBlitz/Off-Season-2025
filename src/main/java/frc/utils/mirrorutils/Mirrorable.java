...
/**
 * A class that allows for objects to be mirrored across the center of the field when the robot is on the red alliance. This is
 * useful for placing field elements and other objects that are mirrored across the field, or for mirroring the target heading to
 * face a field element.
 *
...
public abstract class Mirrorable<T> {
	...
	/**
	 * @return the current object. If the robot is on the red alliance and the object should be mirrored, the mirrored object is
	 *         returned. Otherwise, the non-mirrored object is returned.
	 */
	public T get() {
